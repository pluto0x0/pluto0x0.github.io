...
![Untitled](Untitled%201.png){: .w-50}
...
![Likelihood matrix](Untitled%202.png)
...
![Decision rule](Untitled%203.png)
...
![ML decision rule](Untitled%204.png)
...
![joint probability matrix $\pi_0 = 0.8, \pi_1 = 0.2$ ](Untitled%205.png){: .w-50}
...
![Untitled](Untitled%206.png){: .w-50}
...
![Different distribution in one graph](Untitled%207.png){: .w-75}
...
$$
P\left\{ |\overline{X_n}| \ge s \right\} \le \frac{\sigma^2}{ns^2}
$$
...
- Replace $\sum_{i=1}^n X_i^1 \rightarrow \sum_{i=1}^n X_i-\frac{1}{2}$ when bounded from above.
- Replace $\sum_{i=1}^n X_i^1 \rightarrow \sum_{i=1}^n X_i+\frac{1}{2}$ when bounded from below.
